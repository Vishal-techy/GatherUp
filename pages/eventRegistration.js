  ...
  return (
    <div>
        ...
        <div className='sideNavBar'>
            ...
            <Link style={{textDecoration:'none'}} href="/eventRegistration"><div className='sideLinkWrap'><div className='sideLinkRegistration'>
                <Image className='sideLinkImgRegistration' src={registrations}/>
                <p className='sideLinkTextRegistration'>Registrations</p>
            </div></div></Link>
